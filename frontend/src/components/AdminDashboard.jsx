...
export default function AdminDashboard() {
  ...
  const fetchReservations = () => {
    fetch('http://46.205.243.253:8000/reservations')
      .then((res) => res.json())
  ...
  const handleDelete = (id) => {
    fetch(`http://46.205.243.253:8000/reservations/${id}`, {
      method: 'DELETE',
    })
  ...
  const handleSubmit = (e) => {
    ...
    const url = editingId
      ? `http://46.205.243.253:8000/reservations/${editingId}`
      : 'http://46.205.243.253:8000/appointments';
